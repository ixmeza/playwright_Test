...
class Helper {
    ...
    static async waitWithDeadline(promise, taskName, deadline) {
        let reject;
        const timeoutError = new errors_1.TimeoutError(`Waiting for ${taskName} failed: timeout exceeded. Re-run with the DEBUG=pw:input env variable to see the debug log.`);
